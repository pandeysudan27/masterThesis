package Generator "Model of Thermal cooled Synchronous Generator"
  ...
  */
	...
	model ModGenerator
		...
		parameter Real UAs2Fe = 20 " Heat transfer , stator copper to stator iron , kW /
		K" ;
		...
		//
		parameter Real Rr = 0.16e-3 " Ohmic resistance , rotor copper , kOhm " ;
		parameter Real Rs = 3.5e-6 " Ohmic resistance , stator copper , kOhm " ;
		// Initial state parameters
		parameter Real Tr0 = 94 " Initial temperature of rotor copper temperature , C "
		;
		parameter Real Ts0 = 81 " Initial temperature of stator copper temperature , C
		";
		parameter Real TFe0 = 70 " Initial temperature of stator iron temperature , C "
		;
		parameter Real Hhr0 = HhCu_o + chpCu *( Tr0 - TCu_o ) " Initial rotor specific ␣
		enthalpy , kJ / kg " ;
		parameter Real Hhs0 = HhCu_o + chpCu *( Ts0 - TCu_o ) " Initial stator copper ␣
		specific enthalpy , kJ / kg " ;
		parameter Real HhFe0 = HhFe_o + chpFe *( TFe0 - TFe_o ) " Initial stator iron ␣
		specific enthalpy , kJ / kg " ;
		...
		Qdfs = 0.8* Wdf ;
		// -- specific enthalpies
		Hhr = HhCu_o + chpCu *( Tr - TCu_o ) ;
		Hhs = HhCu_o + chpCu *( Ts - TCu_o ) ;
		HhFe = HhFe_o + chpFe *( TFe - TFe_o ) ;
		Hhac = Hha_o + chpa *( Tac - Ta_o ) ;
		Hhad = Hha_o + chpa *( Tad - Ta_o ) ;
		Hhah = Hha_o + chpa *( Tah - Ta_o ) ;
		// -- total enthalpies
		Hr = mr * Hhr ;
		Hs = ms * Hhs ;
		HFe = mFe * HhFe ;
